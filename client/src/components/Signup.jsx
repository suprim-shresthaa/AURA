            ...
            <>
              ...
              <form onSubmit={handleSignup} className="space-y-3 sm:space-y-4">
                ...
                <InputField
                  ...
                  onBlur={() =>
                    password.length === 0 && setShowPasswordRequirements(false)
                  }
                  ...
                  <div className="mt-2 p-3 bg-gray-50 rounded-lg space-y-1 text-xs sm:text-sm">
                    ...
                    {Object.entries({
                      ...
                      <div key={idx} className="flex items-center gap-2">
                        ...
                        <span
                          className={valid ? "text-green-500" : "text-gray-500"}
                        >
                          {text}
                        </span>
                      </div>
                ...
                <div className="mt-4 sm:mt-6 relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-4 bg-white text-gray-400 text-xs sm:text-sm">
                      or
                    </span>
                  </div>
                </div>
