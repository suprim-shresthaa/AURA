...
const ManageSpareParts = () => {
  ...
  const handleToggleAvailability = async (partId, currentAvailability) => {
    ...
    try {
      ...
      toast.success(
        `Spare part ${!currentAvailability ? "enabled" : "disabled"} successfully`,
      );
    } catch (err) {
      ...
      <div className="mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Manage inventory and availability of spare parts
          </p>
        </div>
                  ...
                  {filteredSpareParts.map((part) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-slate-600 text-sm">
                        {part.pickupLocation?.address &&
                        part.pickupLocation?.city
                          ? `${part.pickupLocation.address}, ${part.pickupLocation.city}`
                          : "—"}
                      </td>
                      <td className="px-6 py-4">
                        <p className="text-sm text-slate-600">
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="flex flex-wrap gap-2">
                            <Button variant="outline" size="sm" asChild>
                              <Link to={`/spare-parts/${part._id}`}>
                                <Eye size={16} />
                              </Link>
                            </Button>
                            <Button variant="outline" size="sm" asChild>
                              <Link to={`/admin/edit-spare-parts/${part._id}`}>
                                <Pencil size={16} />
                              </Link>
                            </Button>
                            <Button
