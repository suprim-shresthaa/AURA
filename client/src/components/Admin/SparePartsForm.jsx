      ...
      <div className="max-w-4xl mx-auto">
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-xl flex items-center gap-3">
            <CheckCircle />{" "}
            {isEdit ? "Spare part updated!" : "Spare part added successfully!"}
          </div>
        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Price per day for renting this part
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-sm text-gray-500 mb-3">
                    Where renters collect this part
                  </p>
                  ...
                  *
                  {isEdit && (
                    <span className="block text-xs font-normal text-gray-500 mt-1">
                      Optional: upload new images to replace current ones. Leave
                      empty to keep existing photos.
                    </span>
                  )}
                </label>
