...
export default function Bookings() {
  ...
  useEffect(() => {
    const filtered = bookings.filter((booking) => {
      ...
      const isSparePart =
        booking.bookingType === "sparePart" || booking.sparePartId;
      ...
      if (isVehicle) {
        ...
        matchesSearch =
          booking.sparePartId?.name
            ?.toLowerCase()
            .includes(searchTerm.toLowerCase()) ||
          booking.sparePartId?.category
            ?.toLowerCase()
            .includes(searchTerm.toLowerCase()) ||
          booking.sparePartId?.brand
            ?.toLowerCase()
            .includes(searchTerm.toLowerCase());
      }
      ...
      <div className="px-6 py-5 border-b border-gray-200">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            View and manage your vehicle and spare part bookings
          </p>
        </div>
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {filteredBookings.map((booking) => {
                  const isVehicle =
                    booking.bookingType === "vehicle" || booking.vehicleId;
                  const entity = isVehicle
                    ? booking.vehicleId
                    : booking.sparePartId;
                  const entityImage = isVehicle
                    ? entity?.mainImage
                    : entity?.images?.[0] || null;
                      ...
                      <tr className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-4 align-top">
                          <div className="flex flex-col gap-2">
                            ...
                            <span
                              className={`inline-flex px-3 py-1 rounded-full text-xs font-medium w-fit ${getPaymentStatusColor(booking.paymentStatus)}`}
                            >
