...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-40 h-dvh left-0 top-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 transition-all duration-300 flex flex-col shrink-0 ${
      ...
      >
        <div className="flex flex-col h-full min-h-0 p-4">
          <div className="flex items-center justify-between mb-8 lg:justify-start">
            ...
            >
              <ArrowLeft className="w-4 h-4  inline-block mr-2" size={20} />{" "}
              Back to Home
            </Link>
          </div>
          {/* Header */}
          <div className="flex items-center justify-between mb-8 lg:justify-center">
            <h1
              className={`font-bold text-white text-xl transition-all duration-200 ${
