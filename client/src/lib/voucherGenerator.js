...
export const generateBookingVoucher = (booking) => {
  ...
  const rows = [
    ...
    ["Customer", data.customerName || data.userId.name],
    ["Customer Email", data.customerEmail || data.userId.email],
    ["Customer Contact", data.customerContact || data.userId.contact],
